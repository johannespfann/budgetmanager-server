...
import de.pfann.budgetmanager.server.persistens.dao.CDBEntryDaoFactory;
...
import de.pfann.budgetmanager.server.persistens.facade.CDBAccountFacade;
import de.pfann.budgetmanager.server.persistens.facade.CDBEntryFacade;
import de.pfann.budgetmanager.server.persistens.facade.CDBStandingOrderFacade;
import de.pfann.budgetmanager.server.persistens.facade.CDBUserFacade;
        ...
        for (File userFolder : userFolders) {
            ...
            for (Account account : accounts) {
                ...
                for (File entryFile : entryFiles) {
                    ...
                    List<Entry> entries = json.fromJson(content, new TypeToken<List<Entry>>() {
                    }.getType());
                ...
                for (File standingOrdersfile : standingOrderFiles) {
                    ...
                    List<StandingOrder> standingOrders = json.fromJson(content, new TypeToken<List<StandingOrder>>() {
                    }.getType());
